...
\author{Aaron Fan (af3623), Akshat Bhandari (ab6174), Tanisha Rathod (tr2828), Wei Alexander Xin (wax1)}
% \date{}
...
\section{Approach and Performance Optimization Techniques}
...
\begin{itemize}
  ...
  \item PyTorch Team, ``Performance Tuning Guide,'' \url{https://pytorch.org/tutorials/recipes/recipes/tuning_guide.html}.
  \item PyTorch Team, ``PyTorch Profiler Documentation,'' \url{https://pytorch.org/}.
  \item Weights \& Biases Documentation, \url{https://wandb.ai/site}.
  \item NVIDIA, ``Nsight Systems Documentation,'' \url{https://developer.nvidia.com/nsight-systems}.
\end{itemize}
